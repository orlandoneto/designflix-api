 ...
 *        description: Não autorizado, token inválido ou expirado.
 */
  app.post("/admin/user/address", AuthenticateRoute(['admin', 'super_admin']), (req, res) =>
    UserAddresService.createFromAdmin(req, res)
  );


  app.get("/user/address", AuthenticateRoute(['admin', 'super_admin', 'installer', 'user']), (req, res) =>
    UserAddresService.getAllByUserId(req, res)
  );
 ...
 *        description: Erro.
 */
  app.put("/user/address/:id", AuthenticateRoute(['admin', 'super_admin', 'user']), (req, res) =>
    UserAddresService.updateById(req, res)
  );


  app.delete("/user/address/:id", AuthenticateRoute(['admin', 'super_admin', 'user']), (req, res) =>
    UserAddresService.deleteById(req, res)
  );
};