module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy":
      "npm i && npx sequelize db:seed:undo:all --env production && npx sequelize db:seed:all --env production && pm2 reload ecosystem.production.config.js --env production && pm2 save --force && pm2 list",
