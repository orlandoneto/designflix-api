module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy":
        "cd /root/api/prd/designflix-api/source && npm i && NODE_ENV=production node scripts/setEnv.js production && npx sequelize-cli db:migrate && pm2 reload ecosystem.production.config.js --only designflix-api-prd && pm2 save --force && pm2 list",
