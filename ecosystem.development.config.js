module.exports = {
  ...
  deploy: {
    staging: {
      ...
      "post-deploy":
        "npm i && npm run build-stg && npx sequelize db:seed:undo:all --env development && npx sequelize db:seed:all --env development && pm2 reload ecosystem.development.config.js && pm2 save --force && pm2 list",
