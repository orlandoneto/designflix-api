module.exports = {
  ...
  deploy: {
    staging: {
      ...
      "post-deploy":
        "npm i && npm run build-dev && ln -sf /root/api/dev/designflix-api/source/src/middleware/private.key /root/api/dev/designflix-api/source/dist/middleware/private.key && pm2 reload ecosystem.development.config.js --env development && pm2 save --force && pm2 list",
