module.exports = {
  ...
  deploy: {
    staging: {
      ...
      "post-deploy":
        "cd /root/api/dev/designflix-api/current && yarn install --frozen-lockfile --non-interactive && pm2 reload ecosystem.development.config.js --only designflix-api-dev && pm2 save --force && pm2 list",
